...
class LineEnv:
    ...
    def reset(self):
        ...
        self.min_speed_list = None
        self.max_speed_list = None

        # 記錄模擬開始時緩存區堆貨上限值 [checked]
        self.m_max_head_buffer_list = None
        self.m_max_tail_buffer_list = None

        # 記錄精確, 當前緩存區緩存數量 [checked]
        self.current_head_queued_list = None
        self.current_tail_queued_list = None
